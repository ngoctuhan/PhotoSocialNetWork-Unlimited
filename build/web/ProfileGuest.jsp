...
<html lang="en">
    <%
        ...
        int personIDGuest = Integer.parseInt(personID);
        Person person = personDAO.getPersonByID(personIDGuest);
        Acount account = acountDAO.getAccount(person.getID());
    ...
    <body>
        ...
        <%
            ...
            //Load album
            List<String> list_user_img = Controler.LoadProfile.loadUserImage(personIDGuest);
            List<String> list_pin_img = Controler.LoadProfile.loadPinImage(personIDGuest);

            //Load post
            List<Post> list_post_user = LoadProfile.loadPostUser(personIDGuest);
        ...
        <div class="profie">
            ...
            <div class="frame">
                ...
                <div class="ava_cover">
                    <form action="ProfileServlet" method="post" enctype = "multipart/form-data">
                        <div class="cover">
                            <a href="<%=person.getCover()%>" data-lightbox="mygallery"> 
                                <img id="u_cover" src="<%=person.getCover()%>" alt="your_cover"> </a>
                    ...
                    <div class="ava">
                        <div class="u_ava">
                            <!--PopUp image-->
                            <a href="<%=person.getAvatar()%>" data-lightbox="mygallery">
                                <img class="ava_popup" src="<%=person.getAvatar()%>" alt="your_ava" ></a>
            ...
            <div class="content">
                                ...
                                <span class="container_tus">
                                    ...
                                    <span class="comment">
                                        ...
                                        <span class="funtion">
                                            ...
                                            <% String color = Utils.CovertBravo.checkBravo(b, person.getPersonID(), post.getID());%>
                                        ...
                                        <span class="funtion">
                                            ...
                                            <% String textPin = Utils.CovertPin.checkPin(pin, person.getPersonID(), post.getUrlImg());
                                                String colorPin = "";
                ...
                <%
                    ...
                    listFollower = relationshipDAO.getFollower(personIDGuest);

                    List<Person> listFollowing = new ArrayList<Person>();
                    listFollowing = relationshipDAO.getFollowing(personIDGuest);
                %>
        ...
        <form action="UpdateCoverServlet" method="POST" enctype = "multipart/form-data" accept-charset="UTF-8">
            ...
            <div class="upload">
                ...
                <div class="show_img">
                    <img id ="img_show" src="<%=person.getCover()%>" alt="image">
                </div>
                <div class="save_img">
        ...
        <form action="UpdateAvatarServlet" method="POST" enctype = "multipart/form-data" accept-charset="UTF-8">
            <div class="change_avatar">
                ...
                <div class="show_avatar">
                    <img id ="ava_show" src="<%=person.getAvatar()%>" alt="image">
                </div>
                <div class="save_ava">
                    <button type = "submit"> Save</button>
                </div>
